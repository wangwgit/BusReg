...
<body style="padding-top:30px;">
	...
	<div class="container">
		<div class="page-header">
			<div class="well">
				<div class="row">
					<form class="form-horizontal" role="form" id="businessHallFrom"
						action="sys/businessHall/add.do" method="post">
						<div class="form-group">
							<label class="col-sm-2 control-label">请选择所属分局</label>
							<div class="col-sm-10">
								<select class="form-control" name="subofficeId">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">分点编号</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="firstname" class="col-sm-2 control-label">分点名称</label>
							<div class="col-sm-10">
	...
	<script type="text/javascript">
		$(function() {
			$('#businessHallFrom').bootstrapValidator({
